...
grammar = OrderedDict(
    {
        ...
        "RxKretk_Adrs_Name": {
            ...
            "ubl_path": False,
            "df_val": False,
            "df_func": "get_address_name(0,2,0)",
        },
        "RxKretk_Adrs_Name2": {
            "type": "str",
            "length": 40,
            ...
            "ubl_path": False,
            "df_val": False,
            "df_func": "get_address_name(1,4,0)",
        },
        "RxKretk_Adrs_Name3": {
            "type": "str",
            "length": 40,
            ...
            "ubl_path": False,
            "df_val": False,
            "df_func": "get_address_name(2,4,0)",
        },
        "RxKretk_Adrs_Name4": {
            "type": "str",
            "length": 40,
            ...
            "ubl_path": False,
            "df_val": False,
            "df_func": "get_address_name(3,4,0)",
        },
        "RxKretk_Adrs_Anrede": {
            "type": "str",
            "length": 15,
        ...
        "RxKretk_Adrs_Adr": {
            ...
            "ubl_path": False,
            "df_val": False,
            "df_func": "get_address_name(3,5,1)",
        },
        "RxKretk_Adrs_Adr2": {
            "type": "str",
            "length": 40,
